...
// CODE HERE
const myStrongest = monstersInYourPocket.filter((pocketmon, index) => pocketmon["CP"] > 200)
console.log(myStrongest)

// In Function Form
// const myStrongest = monstersInYourPocket.filter(function(pocketmon, index) {
//   return pocketmon["CP"] > 200
// })
// console.log(myStrongest)
...
// CODE HERE
const salesTaxTotals = orders.map((order, index) => order.price * order.tax + order.price)
console.log(salesTaxTotals)

// In Function Form
// const salesTaxTotals = orders.map(function(order, index) {
...
// CODE HERE
const bobFilter = purchases.filter((purchase) => purchase.owner === 'Bob')
console.log(bobFilter)

const bobsTotal = bobFilter.reduce((acc, curr) => acc + curr.price, 0)
